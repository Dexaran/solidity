...
contract module {
    ...
    */
    ...
    function disableModule(bool _forever, uint256 _freezTime) external onlyForModuleHandler returns (bool success) {
        _disableModule(_forever, _freezTime);
        return true;
    }
    function _disableModule(bool _forever, uint256 _freezTime) internal {
        /*
        ...
        */
        ...
        disabledUntil = block.number + _freezTime;
    }
